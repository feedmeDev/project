...
class AttendancesControllerTest < ActionController::TestCase
  ...
  test "should create attendance" do
    assert_difference('Attendance.count') do
      post :create, attendance: { going: @attendance.going, meal_id: @attendance.meal_id, person_id: @attendance.person_id }
    end
  ...
  test "should update attendance" do
    patch :update, id: @attendance, attendance: { going: @attendance.going, meal_id: @attendance.meal_id, person_id: @attendance.person_id }
    assert_redirected_to attendance_path(assigns(:attendance))
  end
